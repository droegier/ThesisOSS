...
to such an extent that the data can be used for statistical analysis.
...
We look at several development actions, the corresponding title used in the script is given in brackets.
...
For an explanation of those we refer to the final report, which is included.